  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-900 text-white">
      <main className="flex-1">
        <section className="relative w-full py-24 md:py-32 lg:py-40">
          ...
          <div className="container px-4 md:px-6 text-center">
            <div className="flex flex-col items-center space-y-6">
              <h1 className="text-4xl md:text-6xl font-bold tracking-tighter bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-purple-500 to-teal-400">
              ...
              <div className="w-full max-w-sm">
                {isAuthenticated ? (
                  <Button
                    asChild
                    size="lg"
                    className="w-full bg-white text-gray-900 hover:bg-gray-200 transition-all duration-300 group"
                  >
                    <Link to="/dashboard">
                      Go to Dashboard{" "}
        ...
        <section
          id="features"
          className="w-full py-12 md:py-24 lg:py-32 border-t border-gray-800"
        >
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
              <div className="inline-block rounded-lg bg-gray-800 px-3 py-1 text-sm text-blue-400">
                Key Features
              </div>
            ...
            <div className="mx-auto grid max-w-5xl items-start gap-8 sm:grid-cols-2 md:grid-cols-3 lg:gap-12">
              {features.map((feature) => (
                <div
                  key={feature.title}
                  className="relative group grid gap-4 p-6 rounded-lg bg-gray-900/50 border border-gray-800 hover:border-blue-500/50 transition-all duration-300 overflow-hidden"
                >
                  <div className="absolute -top-1 -left-1 w-24 h-24 bg-blue-500/20 blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
